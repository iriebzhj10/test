...
//        ' <option v-for="article in articles" :key="article.id">{{article.libelle}}</option>'+
//    '</select>'+
...
//     '<td class="text-right amount"><span class="editable-amount"><span class="currency">$</span> <span class="amount">1111</span></td>'+
