...
<meta http-equiv="X-UA-Compatible" content="IE=9; IE=8; IE=7; IE=EDGE">
    ...
    <title>Réintialisation du mot de passe</title>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="640" class="100p">
              <tr>
                ...
                <td align="left" width="50%" class="100padtopbottom" style="padding-left: 20px">
                  <img alt="Logo" src="{{ asset('images/logo.png') }}" width="112" style="width: 100%; max-width: 112px; font-family: Arial, sans-serif; color: #ffffff; font-size: 20px; display: block; border: 0px;" border="0">
                </td>
              </tr>
              {{-- <tr>
                <td colspan="2" width="640" height="160" class="100p">
                  <img alt="Logo" src="{{ asset('images/logo.png') }}" width="640" style="width: 100%; max-width: 640px; font-family: Arial, sans-serif; color: #ffffff; font-size: 20px; display: block; border: 0px; margin-top:0px;" border="0">
                </td>
              </tr> --}}
              <tr>
                <td colspan="2" align="left" valign="center" width="640" height="40" class="100p center" style="font-family: Arial, sans-serif; font-weight: bold; font-size:14px;padding: 0px 20px;">
                  <font face="Arial, sans-serif"><b>Salut!</b></font>
                </td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="center" width="640" class="100p" style="font-family: Arial, sans-serif; font-size:14px; padding: 0px 20px; line-height: 18px;">
                  <font face="Arial, sans-serif">
                    On dirait que vous avez oublié votre mot de passe. Pour le réinitialiser, cliquez simplement sur le bouton ci-dessous.                       <br>
                    Merci,<br>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" style="border-radius: 18px;" bgcolor="#0062FF">
                    ...
                    {{-- <a href="{{ route('show_reset_password', $token) }}">Reset Password</a> --}}
                    <b> </b>
                    <a href="{{ $full_host }}" style="font-size: 14px; font-family: sans-serif; color: #ffffff; text-decoration: none; border-radius: 18px; padding: 5px 16px; border: 1px solid #0062FF; display: inline-block; box-shadow: 0 2px 3px 0 rgba(0,0,0,0.10);">
                    <!--[if mso]> <![endif]-->
                    {{-- {{ $full_host }} --}}
