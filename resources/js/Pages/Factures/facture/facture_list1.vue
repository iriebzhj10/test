<template>
    ...
    <div class="page-header">
        <div class="page-title">
            <h3 v-for="entreprises in entreprise" :key="entreprises.id">Liste des factures 
                <svg xmlns="http://www.w3.org/2000/svg"  color="indigo" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-right"><polyline points="13 17 18 12 13 7"></polyline><polyline points="6 17 11 12 6 7"></polyline></svg>
                {{entreprises.libelle}} </h3>
        </div>
                    ...
                    <div class="invoice-inbox">
                        ...
                        <div class="invoice-header-section">
                            ...
                            <div class="invoice-action">
                                <!-- <svg xmlns="http://www.w3.org/2000/svg" width="24"  height="24"  data-original-title="Creer une facture" viewBox="0 0 24 24" fill="none" stroke="indigo" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-square"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg> -->
                             ...
                             <svg
                                    ...
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="feather feather-printer action-print"
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    data-original-title="Imprimer la facture"
                                >
