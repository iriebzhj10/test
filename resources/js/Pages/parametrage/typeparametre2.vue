<template>
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input id="libelle" type="text" placeholder="" class="form-control" name="libelle" v-model="form.libelle" required>
                                            </div>
                                            <div class="col-lg-6">
                                                <p>Icon<span class="text-danger">*</span></p>
                                                <label for="e-text" class="sr-only"></label>
                                                <input type="text" class="form-control border" name="icon" id="icon" placeholder="fa fa-home" v-model="form.icon">
                                            </div>
                                        </div>
                                    </div><!-- end 1-->
                                    <div>
 ...
 <script>
    ...
    export default{
        ...
        props: ['succes','errors','success_type'],
        data()
        {
            return {
                form:{
