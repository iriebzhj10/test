<template>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-12 mx-auto">
                            <form @submit.prevent="createpara" id="parametre" >
                                ...
                                <div class="title-box">
                                    <h1>Liste des parametres sol</h1>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-9"  >
                                    <div class="col-6 col-md-9"   >
                                        ...
                                        <!-- <div v-for="data2 in resultat" :key="data2.id">
                                                {{ data2.libelle }} 
                                        </div> -->
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr v-for="data2 in resultat" :key="data2.id">
                                                    <th scope="row">2</th>
                                                    <td> {{ data2.libelle }} </td>
                                                    <td> {{ data2.libelle }} </td>
                                                    <td> {{ data2.libelle }} </td>
                            ...
                            <!-- Stack the columns on mobile by making one full-width and the other half-width {{ data1.libelle }}  v-for="data1 in resultat" :key="data1.id"  @click="destroy(datas.id)"      <i class="icofont-ui-delete bg-danger"></i>  -->
                             ...
                             <!-- <div class="col-6 col-md-9"  >
                                    ...
                                    <div class="col-6 col-md-9"   >
                                                ...
                                                bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbvb
 ...
 <script>
    ...
    export default{
        ...
        props: ['data_1','resultat','solution','lol ',],
        data()
        {
            return {
